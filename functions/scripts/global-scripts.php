...
function add_interactive_gradients_script()
{
  wp_enqueue_script(
    ...
    get_template_directory_uri() . '/js/interactiveGradient.js', // this is the location of your script file
    ['jquery'],
...
function add_canvas_noise_script()
{
  wp_enqueue_script(
    ...
    get_template_directory_uri() . '/js/canvasNoise.js', // this is the location of your script file
    ['jquery'],
