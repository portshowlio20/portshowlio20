...
if (in_array('author', (array) $user->roles)) {
  ...
  // 6.(THERE'S A HOLE HERE: IF A USER HAS 3 PROJECTS, SETS ONE TO DRAFT, THEN MAKES AND PUBLISHES A NEW PROJECT, THEN RETURNS TO THE DRAFT PROJECT, THEY CAN SET THAT TO PUBLISH AND GET 4 PROJECTS)
